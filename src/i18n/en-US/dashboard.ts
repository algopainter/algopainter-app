export default {
  ...
  newPainting: {
    ...
    gwei: {
      ...
      infoBtn: 'Learn More',
      artMintingFee: 'I accept to pay {feeAmount} {collectionCurrency} to mint this artwork',
    },
    expressions: {
    ...
    dialog: {
      ...
      statuses: {
        ...
        generatingPreviewFileError: 'An error has occurred while generating the preview file... Try again!',
        ...
        generatingDescriptorFileError: 'An error has occurred while generating the descriptor file... Try again!',
        ...
        mintAwaitingInput: 'Please interact with your wallet!',
        mintAwaitingConfirmation: 'Waiting for the wallet approval...',
  ...
  auctionPage: {
    ...
    textRemoveBid: 'By removing your bid, you are not eligible to participate in the BidBack if you have a stake. I understand and I agree with that.',
  ...
  createCollection: {
    ...
    stepTwo: {
      ...
      startDT: 'Start date:',
      endDT: 'End date:',
      dateB42day: "You cannot set a date previous to today's date",
      dateMin: 'The collection needs to be running for at least one full day',
      datePast: 'You cannot set an ending date previous to the starting date',
      ...
      isErr: 'You need to correct one or more fields in the form before moving on to the next step',
