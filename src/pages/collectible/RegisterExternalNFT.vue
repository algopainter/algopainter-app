...
export default class registerExternalNFT extends Vue {
        ...
        for (let i = 0; i < numOfNfts; i++) {
          ...
          await fetch(tokenURI)
            ...
            .then((output) => {
              ...
              this.nftDescriptorList[i].name = output.name
                ? output.name
                : undefined;
              this.nftDescriptorList[i].description = output.description
                ? output.description
                : undefined;
              this.nftDescriptorList[i].image = output.imagePreview
                ? output.imagePreview
                : output.image;
              ...
              active
                ? this.nftsActiveIdsList.push(tokenId)
  ...
  async registerNFTs() {
    ...
    this.externalNftManager = new AlgoPainterExternalNftManagerProxy(
      this.networkInfo
    );
