<template>
  <q-card>
    <q-card-section class="header">
      {{ $t('dashboard.auctionPage.removeBids') }}
    </q-card-section>
    <q-card-section>
...
export default class RemoveBid extends Vue {
  ...
  get firstStepLabel() {
    switch (this.removeBidStatus) {
      case RemoveBidStatus.RemoveBidAwaitingInput:
        return this.$t('dashboard.auctionPage.removeBidStatuses.awaitingInput');
      case RemoveBidStatus.RemoveBidError:
        return this.$t('dashboard.auctionPage.removeBidStatuses.error');
      case RemoveBidStatus.RemoveBidAwaitingConfirmation:
        return this.$t('dashboard.auctionPage.removeBidStatuses.awaitingConfirmation');
      default:
        return this.$t('dashboard.auctionPage.removeBidStatuses.bidRemove');
    }
  }
