<template>
  <div class="btn-container q-mx-auto row items-center justify-center">
    ...
    <div class="q-mx-auto row items-center justify-center">
      <div class="btn-container q-mx-auto flex justify-center items-center">
        <algo-button
          v-for="(btn, index) in galleryButtons"
          :key="index"
          :label="$t(`dashboard.homePage.${btn.label}`) + btn.cont"
          outline
          class="algo-button q-px-md q-ml-sm"
          :color="currentBtnClicked === btn.btnClicked ? 'primary' : 'grey-5'"
          @click="btn.action"
        />
      </div>
    </div>
  ...
  <div class="row q-col-gutter-lg">
    <div
      v-if="!loadingGalleryArtsButtons && currentBtnClicked === 1"
      class="col-md-9 col-lg-9 flex q-col-gutter-md"
    >
      <div v-if="!loadingGalleryArts">
        <div
          v-if="!nullGalleryArts"
  ...
  async getGalleryArts(
    ...
    await this.$store
      ...
      .then(() => {
        ...
        this.galleryButtons[0].cont = ` (${contImg})`;
  ...
  async getLikes(
    ...
    await this.$store
      ...
      .then(() => {
        ...
        this.galleryButtons[2].cont = `(${contLiked})`;
